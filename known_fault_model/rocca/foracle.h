...
/* omitting the finalization process for the faulty rocca enc */
void frocca_enc( uint64_t *state, uint64_t *cip, uint64_t *tag, uint64_t *k0, uint64_t *k1, uint64_t *nonce, 
