/* gist: this is the improvement state recovery attack of rocca. Here the fault structure is like, we can give 4 random */
...
int main(){
    ...
    /* keys k0 and k1 */
    insert(k0, 0x0abcdef123456789, 0x0123456789abcdef);
